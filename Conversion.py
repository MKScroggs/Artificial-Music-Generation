...
def convert_default_midi_folder(overwrite=False, base_note=4, beats_per_measure=4, smallest_note=4, triplets=False):
    MC.convert_midi_folder(os.path.dirname(os.path.realpath(__file__)), overwrite, base_note, beats_per_measure, smallest_note, triplets)
    
def convert_default_txt_folder(overwrite=False):
    MC.convert_txt_folder(os.path.dirname(os.path.realpath(__file__)), overwrite)
